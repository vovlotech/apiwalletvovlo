...
exports.dbCoins = exports.masterWalletLocks = exports.web3 = exports.chainMapping = exports.abi = exports.toWei = exports.fromWei = exports.toDecimals = exports.fromDecimals = exports.toSatoshi = exports.fromSatoshi = exports.TRX_GAS_FEE = exports.STABLE_MINIMUM = exports.tronWeb = exports.BITCOIN_TOKEN = exports.TRONGRID_API_KEY = exports.TRONSCAN_API_KEY = exports.TRON_SCAN_URL = exports.TRON_RPC = exports.generateStringId = exports.bitCoinRootUrl = exports.BITCOIN_NETWORK_MAINNET = exports.BITCOIN_NETWORK = exports.ECPair = void 0;
...
exports.ECPair = (0, ecpair_1.ECPairFactory)(ecc);
exports.BITCOIN_NETWORK = bitcoin.networks.testnet;
exports.BITCOIN_NETWORK_MAINNET = bitcoin.networks.bitcoin;
const BN = require('bn.js');
exports.bitCoinRootUrl = 'https://api.blockcypher.com/v1/btc/test3';
const generateStringId = () => new mongoose_1.Types.ObjectId().toString();
exports.generateStringId = generateStringId;
exports.TRON_RPC = 'https://api.shasta.trongrid.io';
exports.TRON_SCAN_URL = 'https://shastapi.tronscan.org';
exports.TRONSCAN_API_KEY = '3c5687de-b88d-479b-84fb-1f7304215dc5';
exports.TRONGRID_API_KEY = '7e6b343f-516c-4c47-9c13-9e3a304e81a0';
exports.BITCOIN_TOKEN = 'a9577cefe0a840008b339bbc5a567ee3';
const HttpProvider = TronWeb.providers.HttpProvider;
const fullNode = new HttpProvider(exports.TRON_RPC);
exports.tronWeb = new TronWeb({
    fullHost: fullNode,
    headers: { 'TRON-PRO-API-KEY': exports.TRONGRID_API_KEY },
});
exports.STABLE_MINIMUM = 50;
exports.TRX_GAS_FEE = 15;
const SATOSHI = 100000000;
const fromSatoshi = (number) => {
    return number / SATOSHI;
};
exports.fromSatoshi = fromSatoshi;
const toSatoshi = (number) => {
...
exports.web3 = new Web3('https://polygon-rpc.com');
exports.masterWalletLocks = {
    isEVMLocked: 0,
    isTRONLocked: 0,
    isBTCLocked: 0,
};
